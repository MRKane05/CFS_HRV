...
public class MessageDisplayManager {
    ...
    private List<String> stage2Messages = Arrays.asList(
            ...
            "Exposure can be set in the info tab, to: Automatic, Remembered, or User. User lets you tune it yourself",
            "If you miss the auto-exposure simply switch tabs to restart the process",
            "Try to get a consistent saw-tooth shaped pattern before starting the record",
    ...
    private List<String> stage4Messages = Arrays.asList(
            ...
            "However when you begin predictions will most likely not be as accurate as they could be",
